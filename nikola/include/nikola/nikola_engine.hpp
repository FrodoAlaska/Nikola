...
const f64 NIKOLA_PI        = 3.14159265359;

const f32 NIKOLA_RAD2DEG   = (180.0f / NIKOLA_PI);

const f32 NIKOLA_DEG2RAD   = (NIKOLA_PI / 180.0f);

const f64 NIKOLA_EPSILON   = 1.192092896e-07f;

const f64 NIKOLA_FLOAT_MIN = -3.40282e+38F;

const f64 NIKOLA_FLOAT_MAX = 3.40282e+38F;
