...
struct AudioBufferID {
  AudioBufferID() = default;

  AudioBufferID(const u32 id)
    :_id(id)
  {}
  
  public:
    const u32 get_id() const {return _id;}
...
NIKOLA_API void audio_source_set_buffer(AudioSourceID& source, AudioBufferID& buffer);
