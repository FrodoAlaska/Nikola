...
RayIntersection ray_check_intersection(const Ray& ray, const Transform& trans, Collider& collider) {
  collider.min = trans.position - collider.half_size; 
  collider.max = trans.position + collider.half_size; 
