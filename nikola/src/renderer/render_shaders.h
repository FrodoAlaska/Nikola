...
inline nikola::GfxShaderDesc generate_batch_quad_shader() {
  return nikola::GfxShaderDesc {
    ...
    "  vs_out.tex_coords = aTextureCoords;\n"
    "\n"
    "  gl_Position = vec4(vec2(aPos), 0.0f, 1.0f);\n"
    "}\n"
    "\n",
...
inline nikola::GfxShaderDesc generate_batch_circle_shader() {
  return nikola::GfxShaderDesc {
    "#version 460 core\n"
    "\n"
    "// Layouts\n"
...
inline nikola::GfxShaderDesc generate_batch_polygon_shader() {
  return nikola::GfxShaderDesc {
    "#version 460 core\n"
    "\n"
    "// Layouts\n"
    ...
    "  if(all(lessThan(color.rgb, vec3(0.0)))) {\n"
    "    discard;"
    "  }\n"
    "\n"
    "  frag_color = vec4(vec3(fs_in.poly_count), 1.0) * fs_in.out_color;\n"
    "}\n"
  };
}
