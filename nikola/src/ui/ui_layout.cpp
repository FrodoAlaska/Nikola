...
void ui_layout_create(UILayout* layout, const Vec2& bounds, const ResourceID& font_id) {
...
UIText& ui_layout_push_text(UILayout& layout, 
                            const String& str, 
                            const f32 size, 
                            const Vec4& color, 
  ...
  UITextDesc text_desc = {
    ...
    .canvas_bounds = layout.bounds, 

    .offset = layout.current_offset + layout_padding,
    .color  = color,
  };
  ui_text_create(&text, text_desc);
...
UIButton& ui_layout_push_button(UILayout& layout, 
                                const String& str, 
                                const f32 size, 
                                const Vec4& color, 
  ...
  ui_button_create(&button, button_desc);
...
UICheckbox& ui_layout_push_checkbox(UILayout& layout, 
                                    const f32 size, 
                                    const Vec4& color, 
                                    const Vec4& outline_color, 
                                    const i32 bind_id,
  ...
  ui_checkbox_create(&checkbox, desc);
...
UISlider& ui_layout_push_slider(UILayout& layout, 
                                f32* value,
                                const f32 min, 
                                const f32 max,
                                const f32 step,
...
UIImage& ui_layout_push_image(UILayout& layout, 
